...
let ExploreOptionsNearMe = () => {
    let chain = ['Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag', 'Raj', 'cheenai', 'vizag']
